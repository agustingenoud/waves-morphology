...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 367.299999999999727, 244.0, 139.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 367.299999999999727, 108.0, 152.0, 38.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 367.299999999999727, 192.0, 152.0, 38.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 367.299999999999727, 149.0, 152.0, 38.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 367.300000000000011, 26.0, 150.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 367.299999999999727, 80.0, 152.0, 22.0 ],
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 367.300000000000011, 50.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 221.41111111111087, 244.0, 139.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 47.0, 226.0, 95.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
					"patching_rect" : [ 123.0, 197.0, 63.0, 22.0 ],
...
,
					"patching_rect" : [ 47.0, 197.0, 63.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 340.522222222222013, 312.0, 114.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 221.41111111111087, 312.0, 114.0, 60.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 165.0, 205.0, 35.0, 22.0 ],
									"text" : "out 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.0, 102.0, 34.0, 22.0 ],
									"text" : "latch"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.0, 56.0, 44.0, 22.0 ],
									"text" : "history"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 14.0, 67.0, 22.0 ],
									"text" : "in 1 source"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 305.0, 14.0, 48.0, 22.0 ],
									"text" : "in 2 trig"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 1 ],
									"midpoints" : [ 314.5, 85.0, 74.5, 85.0 ],
									"order" : 1,
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 1 ],
									"midpoints" : [ 314.5, 86.5, 189.5, 86.5 ],
									"order" : 0,
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 0 ],
									"midpoints" : [ 59.5, 143.0, 117.0, 143.0, 117.0, 45.0, 174.5, 45.0 ],
									"order" : 0,
									"source" : [ "obj-5", 0 ]
								}
...
,
					"patching_rect" : [ 221.522222222222013, 184.0, 138.0, 22.0 ],
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 47.522222222222013, 300.0, 47.727777777777987, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 221.41111111111087, 108.0, 114.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 102.299999999999727, 108.0, 114.0, 60.0 ]
				}
...
,
					"patching_rect" : [ 102.299999999999727, 80.0, 257.222222222222285, 22.0 ],
					"text" : "gen~"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 260.91111111111087, 301.0, 350.022222222222013, 301.0 ],
					"order" : 0,
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 230.91111111111087, 302.0, 193.205555555555406, 302.0, 193.205555555555406, 186.0, 56.5, 186.0 ],
					"order" : 1,
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 260.91111111111087, 302.0, 193.205555555555406, 302.0, 193.205555555555406, 186.0, 132.5, 186.0 ],
					"order" : 1,
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 406.799999999999727, 301.0, 350.022222222222013, 301.0 ],
					"order" : 0,
					"source" : [ "obj-31", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 376.799999999999727, 301.0, 230.91111111111087, 301.0 ],
					"order" : 0,
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 376.799999999999727, 301.0, 193.649999999999864, 301.0, 193.649999999999864, 186.0, 56.5, 186.0 ],
					"order" : 1,
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-21", 0 ],
					"midpoints" : [ 406.799999999999727, 301.0, 193.649999999999864, 301.0, 193.649999999999864, 186.0, 132.5, 186.0 ],
					"order" : 1,
					"source" : [ "obj-31", 1 ]
				}
